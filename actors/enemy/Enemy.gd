...
func _ready() -> void:
	...
	hp = max_hp
	$"Sprite".texture = load("res://actors/enemy/enemy_blob.png")
...
func _spawn_impact() -> void:
	var scene := load("res://vfx/Impact.tscn") as PackedScene
...
func _die() -> void:
	...
	var particle_scene := load("res://vfx/ExplosionParticles.tscn") as PackedScene
	if particle_scene:
