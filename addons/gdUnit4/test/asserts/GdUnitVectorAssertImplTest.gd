...
func test_is_equal_approx() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector2(1, 0.995)).is_equal_approx(Vector2.ONE, Vector2(0, 0.004))
		)
		. is_failed()
		. has_message("Expecting:\n '(1, 0.995)'\n in range between\n '(1, 0.996)' <> '(1, 1.004)'")
	)
	...
	(
		assert_failure(
			func() -> void:
				assert_vector(Vector3(0.0, 0.878431, 0.505882)).is_equal_approx(
...
func test_is_between(fuzzer := Fuzzers.rangev2(Vector2.ZERO, Vector2.ONE)) -> void:
	...
	(
		assert_failure(
			func() -> void: assert_vector(Vector2(1, 1.00001)).is_between(Vector2.ZERO, Vector2.ONE)
		)
		. is_failed()
		. has_message("Expecting:\n '(1, 1.00001)'\n in range between\n '(0, 0)' <> '(1, 1)'")
	)
	...
	(
		assert_failure(
			func() -> void: assert_vector(Vector2(1, 1.00001)).is_between(Vector2.ZERO, Vector3.ONE)
		)
		. is_failed()
		. has_message("Unexpected type comparison:\n Expecting type 'Vector2' but is 'Vector3'")
	)
