...
func before() -> void:
	_saved_report_assert_warnings = ProjectSettings.get_setting(
		GdUnitSettings.REPORT_ASSERT_WARNINGS
	)
...
func after() -> void:
	ProjectSettings.set_setting(
		GdUnitSettings.REPORT_ASSERT_WARNINGS, _saved_report_assert_warnings
	)
...
func test_extractv() -> void:
	...
	(
		...
		. contains_exactly(
			[tuple("A", 10), tuple("B", "foo"), tuple("n.a.", "n.a."), tuple("C", 11)]
		)
	)
	# tuple of three
	(
