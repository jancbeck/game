...
func test_is_equal() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_str("This is a test message").is_equal("This is a test Message")
		)
		. is_failed()
		. has_message(
			(
...
func test_is_equal_pipe_character() -> void:
	assert_failure(func() -> void: assert_str("AAA|BBB|CCC").is_equal("AAA|BBB.CCC")).is_failed()
...
func test_is_not_equal_ignoring_case() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_str("This is a test message").is_not_equal_ignoring_case(
					"This is a test Message"
				)
		)
		. is_failed()
...
func test_contains_ignoring_case() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_str("This is a test message").contains_ignoring_case("a Tesd")
		)
		. is_failed()
		. has_message(
			(
...
func test_not_contains_ignoring_case() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_str("This is a test message").not_contains_ignoring_case("a Test")
		)
		. is_failed()
		. has_message(
			(
...
func test_ends_with() -> void:
	...
	(
		assert_failure(
			func() -> void: assert_str("This is a test message").ends_with("tes message")
		)
		. is_failed()
		. has_message(
			(
...
func test_fluentable() -> void:
	assert_str("value a").is_not_equal("a").is_equal("value a").has_length(7).is_equal("value a")
...
func test_override_failure_message() -> void:
	assert_object(assert_str("").override_failure_message("error")).is_instanceof(
		GdUnitStringAssert
	)
	(
		assert_failure(
			func() -> void:
				assert_str("").override_failure_message("Custom failure message").is_null()
		)
		. is_failed()
...
func test_append_failure_message() -> void:
	...
	(
		assert_failure(
			func() -> void:
				assert_str("").append_failure_message("custom failure data").is_not_empty()
		)
		. is_failed()
		. has_message(
			(
...
func test_is_failure() -> void:
	...
	assert_failure(func() -> void: assert_str(RefCounted.new()).is_null()).is_failed()
