...
func test_attribute() -> void:
	var element := XmlElement.new("testsuites").attribute(JUnitXmlReport.ATTR_ID, "1").attribute(
		JUnitXmlReport.ATTR_NAME, "foo"
	)
	var expected := (
		"""
...
func test_add_child() -> void:
	var child := XmlElement.new("foo").attribute(JUnitXmlReport.ATTR_ID, "1").attribute(
		JUnitXmlReport.ATTR_NAME, "foo"
	)
	var element := (
		XmlElement
...
func test_add_childs() -> void:
	var child_a := XmlElement.new("foo_a").attribute(JUnitXmlReport.ATTR_ID, 1).attribute(
		JUnitXmlReport.ATTR_NAME, "foo_a"
	)
	var child_b := XmlElement.new("foo_b").attribute(JUnitXmlReport.ATTR_ID, 2).attribute(
		JUnitXmlReport.ATTR_NAME, "foo_b"
	)
	var element := (
		XmlElement
		. new("bar")
...
func test_complex_example() -> void:
	var testsuite1 := XmlElement.new("testsuite").attribute(JUnitXmlReport.ATTR_ID, "1").attribute(
		JUnitXmlReport.ATTR_NAME, "bar"
	)
	...
	var testsuite2 := XmlElement.new("testsuite").attribute(JUnitXmlReport.ATTR_ID, "2").attribute(
		JUnitXmlReport.ATTR_NAME, "bar2"
	)
