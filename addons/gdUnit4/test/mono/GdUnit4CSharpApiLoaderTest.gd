...
func before(
	do_skip := not GdUnit4CSharpApiLoader.is_mono_supported(),
	skip_reason := "Do run only for Godot Mono version"
) -> void:
	pass
...
func test_parse_test_suite() -> void:
	var test_suite := GdUnit4CSharpApiLoader.parse_test_suite(
		"res://addons/gdUnit4/test/mono/GdUnit4CSharpApiTest.cs"
	)
