...
func test_parse_function_arguments() -> void:
	assert_dict(_parser._parse_function_arguments("func foo():")).has_size(0)
	...
	(
		assert_dict(
			_parser._parse_function_arguments(
				'func foo(arg1 :int, arg2 :bool, name :String = "abc"):'
			)
		)
		. has_size(3)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
	...
	(
		assert_dict(
			_parser._parse_function_arguments("func foo(arg1, arg2=value(1,2,3), name:=foo()):")
		)
		. has_size(3)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
	...
	(
		assert_dict(
			_parser._parse_function_arguments("func create_timer(timeout :float) -> Timer:")
		)
		. has_size(1)
	...
	(
		assert_dict(
			_parser._parse_function_arguments(
				"func foo(a :int, b :int, parameters = [[1, 2], [3, 4], [5, 6]]):"
			)
		)
		. has_size(3)
		...
		assert_dict(
			(
				...
				. _parse_function_arguments(
					"func test_values(a:Vector2, b:Vector2, expected:Vector2, test_parameters:=[[Vector2.ONE,Vector2.ONE,Vector2(1,1)]]):"
				)
			)
		)
		. has_size(4)
...
func test_parse_arguments_default_build_in_type_string() -> void:
	...
	(
		assert_dict(
			_parser._parse_function_arguments('func foo(arg1 :String, arg2 :String ="default"):')
		)
		. has_size(2)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
		. contains_key_value("arg2", '"default"')
...
func test_parse_arguments_default_build_in_type_array() -> void:
	...
	(
		assert_dict(
			_parser._parse_function_arguments("func foo(arg1 :String, arg2 :Array=Array()):")
		)
		. has_size(2)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
	...
	(
		assert_dict(
			_parser._parse_function_arguments("func foo(arg1 :String, arg2 :Array=[1, 2, 3]):")
		)
		. has_size(2)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
	...
	(
		assert_dict(
			_parser._parse_function_arguments(
				"func foo(arg1 :String, arg2 :Array=[1, 2, 3], arg3 := false):"
			)
		)
		. has_size(3)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
...
func test_parse_arguments_default_build_in_type_color() -> void:
	...
	(
		assert_dict(
			_parser._parse_function_arguments("func foo(arg1 :String, arg2 :Color=Color.RED):")
		)
		. has_size(2)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
		. contains_key_value("arg2", "Color.RED")
...
func test_parse_arguments_default_build_in_type_vector() -> void:
	(
		assert_dict(
			_parser._parse_function_arguments("func bar(arg1 :String, arg2 =Vector3.FORWARD):")
		)
		. has_size(2)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
	...
	(
		assert_dict(
			_parser._parse_function_arguments(
				"func bar(arg1 :String, arg2 :Vector3=Vector3.FORWARD):"
			)
		)
		. has_size(2)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
...
func test_parse_arguments_default_build_in_types() -> void:
	(
		assert_dict(
			_parser._parse_function_arguments(
				"func bar(arg1 :String, arg2 := Vector3.FORWARD, aabb := AABB()):"
			)
		)
		. has_size(3)
		. contains_key_value("arg1", GdFunctionArgument.UNDEFINED)
	...
	(
		assert_dict(
			(
				_parser
				. _parse_function_arguments(
					"func test_foo(fuzzer_a = fuzz_a(), fuzzer_b := fuzz_b(), fuzzer_c :Fuzzer = fuzz_c(), fuzzer_iterations = 234, fuzzer_seed = 100):"
				)
			)
		)
		. has_size(5)
...
func test_load_source_code_inner_class_AtmosphereData() -> void:
	...
	var file_content := resource_as_string(
		"res://addons/gdUnit4/test/core/resources/AtmosphereData.txt"
	)
...
func test_strip_leading_spaces() -> void:
	...
	assert_str(GdScriptParser.TokenInnerClass._strip_leading_spaces("class foo")).is_equal(
		"class foo"
	)
...
func test_parse_func_description() -> void:
	...
	assert_that(fds[0]).is_equal(
		GdFunctionDescriptor.create("foo0", script.resource_path, 4, GdObjects.TYPE_VOID)
	)

	# static function
	assert_that(fds[1]).is_equal(
		GdFunctionDescriptor.create_static(
			"foo1",
...
func test_parse_class_inherits() -> void:
	...
	(
		...
		. contains_exactly(
			[
				GdFunctionDescriptor.create(
					"foo2",
					"res://addons/gdUnit4/test/mocker/resources/CustomClassExtendsCustomClass.gd",
					6,
	...
	(
		assert_str(
			(
				...
				. get_class_name(
					load(
						"res://addons/gdUnit4/test/core/resources/naming_conventions/extends_on_same_line.gd"
					)
				)
			)
		)
				...
				. create(
					...
					[
						...
						GdFunctionArgument.new(
							"parameters", TYPE_ARRAY, "[[1,2,3,6],[3,4,5,11],[6,7,8,21]]"
						),
					]
				)
			)
			...
			(
				...
				. create(
					...
					[
						...
						GdFunctionArgument.new(
							"fuzzer", GdObjects.TYPE_FUZZER, "Fuzzers.rangei(-23, 22)"
						),
