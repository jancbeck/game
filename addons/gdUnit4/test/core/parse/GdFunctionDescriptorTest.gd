	...
	assert_array(fd.varargs()).contains_exactly(
		[
			GdFunctionArgument.new(
				"vararg0_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg1_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg2_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg3_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg4_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg5_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg6_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg7_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg8_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			),
			GdFunctionArgument.new(
				"vararg9_", GdObjects.TYPE_VARARG, '"%s"' % GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
			)
		]
	)
...
func test_extract_from_descriptor_is_virtual_func_full_check() -> void:
	...
	if Engine.get_version_info().hex >= 0x40400:
		expected_virtual_functions.append_array(["_iter_init", "_iter_next", "_iter_get"])
...
func test_extract_return_type(
	...
	test_parameters := [
		...
		[
			"return_int",
			TYPE_INT,
			{"name": "", "class_name": &"", "type": 2, "hint": 0, "hint_string": "", "usage": 0}
		],
		[
			"return_string",
			TYPE_STRING,
			{"name": "", "class_name": &"", "type": 4, "hint": 0, "hint_string": "", "usage": 0}
		],
		[
			"return_void",
			GdObjects.TYPE_VOID,
