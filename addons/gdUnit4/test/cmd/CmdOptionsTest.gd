...
func test_default_options() -> void:
	assert_array(_cmd_options.default_options()).contains_exactly([option_a, option_f, option_b])
...
func test_options() -> void:
	assert_array(_cmd_options.options()).contains_exactly([option_a, option_f, option_b, option_x])
