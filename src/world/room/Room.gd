...
@export var enemy_scene: PackedScene = preload("res://src/actors/enemy/Enemy.tscn")
@export var player_scene: PackedScene = preload("res://src/actors/player/Player.tscn")
@export var boon_scene: PackedScene = preload("res://src/items/boon/Boon.tscn")
...
func _ready() -> void:
	$"Background".texture = load("res://src/world/room/room_base.png")
	...
	var bottom_wall_tex := load("res://src/world/room/room_bottom.png") as Texture2D
	if bottom_wall_tex:
