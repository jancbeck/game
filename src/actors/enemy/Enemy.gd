...
func _ready() -> void:
	...
	hp = max_hp
	$"Sprite".texture = load("res://src/actors/enemy/enemy_blob.png")
...
func take_damage(amount: int) -> void:
	...
	# Brief hit-stop when enemy is hit (skip if no valid tree)
...
func _spawn_impact() -> void:
	var scene := load("res://src/vfx/Impact.tscn") as PackedScene
...
func _die() -> void:
	...
	var particle_scene := load("res://src/vfx/ExplosionParticles.tscn") as PackedScene
	if particle_scene:
